...
const EVENT_DATABASE: EventEntry[] = [
  { id: 'blackout', name: 'Blackout Protocol', triggerTime: '7:00 & 14:00', duration: '30s', dangerLevel: 1, color: '#00ffff', icon: 'zap', description: 'Grid power fluctuation amplifies neural data streams.', effect: '3× XP multiplier on all kills during the event.', survivalTip: 'Go aggressive — kill everything. This is your power spike moment.', reward: 'Data Core on completion' },
  { id: 'system_breach', name: 'System Breach', triggerTime: 'Random (2min+)', duration: '45s', dangerLevel: 3, color: '#ff4444', icon: 'alert', description: 'Security protocols compromised. Enemy portals activate across the grid.', effect: 'Enemies spawn from portal locations. Exfill portals disabled.', survivalTip: 'Stay near the center. Avoid getting pinched between portal spawn points.', reward: 'Data Core on survival' },
  { id: 'bounty_target', name: 'Bounty Target', triggerTime: '3:00 (repeating)', duration: '20s', dangerLevel: 2, color: '#ffd700', icon: 'target', description: 'High-value golden elite detected. Eliminate within the time limit.', effect: 'A golden elite spawns with a countdown timer. Kill it for massive XP burst.', survivalTip: 'Drop everything and focus fire. 10× gem burst plus Data Core.', reward: 'Data Core + Gold + 500 XP burst' },
  { id: 'supply_drop', name: 'Supply Drop', triggerTime: 'When HP < 50%', duration: 'Until collected', dangerLevel: 2, color: '#00ccff', icon: 'package', description: 'Emergency supply crate deployed. Guarded by a tank-class enemy.', effect: 'Glowing crate spawns at range. A Goliath guards it. Collect for healing.', survivalTip: 'Kill the guard first. The +50 HP can save a losing run.', reward: '+50 HP + Data Core' },
  { id: 'data_storm', name: 'Data Storm', triggerTime: 'Random (5min+)', duration: '15s', dangerLevel: 3, color: '#00ffff', icon: 'storm', description: 'A wall of corrupted data sweeps across the grid.', effect: 'Cyan particle wall moves horizontally or vertically. Drops XP gems in its path but damages on contact (3 DPS).', survivalTip: 'Follow behind the wall to collect free XP. Never stand in it.', reward: 'Free XP gems & coins in storm path' },
  { id: 'nano_plague', name: 'Nano Plague', triggerTime: '10:00+ (500 kills)', duration: '45s', dangerLevel: 4, color: '#00ff44', icon: 'biohazard', description: 'Nanite contamination event. Enemy corpses release toxic residue.', effect: '40% of kills spawn toxic pools dealing 8 DPS for 5 seconds.', survivalTip: 'Keep moving. Never fight in one spot — the pools stack up fast.', reward: 'Survival endurance test — no direct reward' },
  { id: 'firewall_collapse', name: 'Firewall Collapse', triggerTime: '16:00 (once)', duration: '30s', dangerLevel: 5, color: '#ff0000', icon: 'fire', description: 'Grid boundary systems failing. The arena shrinks.', effect: 'Arena walls close in by up to 400px. 15 DPS outside boundary. Enemies pushed inward.', survivalTip: 'Move to center IMMEDIATELY. The damage outside is lethal in seconds.', reward: 'Data Core on survival' },
];
