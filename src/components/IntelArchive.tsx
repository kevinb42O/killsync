...
const ENEMY_DATABASE: EnemyEntry[] = [
  ...
  { key: 'fast', ...ENEMY_TYPES.fast, spawnTime: '2:00', threatLevel: 2, description: 'Lightweight reconnaissance unit with boosted servos. Flanks and overwhelms.', behavior: 'Sprints in rapid off-axis flanking arcs to encircle the player on foot. No teleportation.', tip: 'Use high fire-rate weapons or area attacks to clear them before they flank your position.' },
